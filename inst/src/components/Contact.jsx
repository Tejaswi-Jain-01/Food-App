...
const Contact = () => {
  ...
  return (
    ...
    <h1 className="text-5xl font-semibold text-white">Contact Us</h1>
      ...
      <div className="flex sm:h-[40rem]">

        <div className="border-2 text-center items-center  sm:h-[36rem] md:w-[50%]  bg-rose-200  m-auto rounded-3xl text-black">
          <h1 className="font-bold text-3xl">Get In Touch</h1>

          <div className="flex mt-[3rem] ">
            <input type="text" placeholder="First Name" className=" m-auto rounded-2xl text-center bg-gradient-to-br from-orange-100 to-sky-200  md:h-[3rem] sm:w-[14rem] " />
          ...
          <textarea placeholder="type your message here!" className="m-auto mt-[2rem] rounded-2xl text-center bg-gradient-to-br from-pink-100 to-sky-200 h-[6rem] w-full " />
        ...
        <div className="sm::mt-2  rounded-3xl m-auto   text-black">
          <img src={chef} alt="" className="md:h-[20rem] sm:w-[20rem] sx:m-auto" />
